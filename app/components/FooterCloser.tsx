    ...
    <footer className="w-full bg-[var(--bg-surface)] border-t border-[var(--border-subtle)] relative overflow-hidden">
      ...
      <div className="border-t border-[var(--border-subtle)] bg-[var(--bg-primary)]/20 py-16 relative z-10">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Compliance Info */}
          <div className="flex flex-col gap-4">
            <h4 className="text-xs font-mono uppercase tracking-widest text-[var(--text-core)] font-bold">Compliance</h4>
            <div className="text-caption flex flex-col gap-2">
              <span>GDPR / CCPA Registered Protocols</span>
              <span>Kenyan Data Protection Act Compliant</span>
            ...
            <div className="text-caption flex flex-col gap-0.5 mt-2">
              <span className="font-semibold text-[var(--text-core)]">Contact Pipeline:</span>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 mt-12 pt-8 border-t border-[var(--border-subtle)] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 flex-wrap justify-center sm:justify-end">
            <span className="text-caption">Diani Beach Road, Kwale County, Kenya</span>
            <div className="flex items-center gap-2">
              <a href="https://www.facebook.com/goldfishmarketingKE" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-[var(--text-muted)] hover:text-[var(--accent-gold)] transition-colors duration-200">
              ...
              <a href="https://www.instagram.com/goldfishmarketingke/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-[var(--text-muted)] hover:text-[var(--accent-gold)] transition-colors duration-200">
              ...
              <a href="https://www.tiktok.com/@goldfishmarketingke" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-[var(--text-muted)] hover:text-[var(--accent-gold)] transition-colors duration-200">
